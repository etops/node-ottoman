...
describe('Namespace', function () {
    ...
    this.timeout(10000);
    it('should be able to make reference between namespaces, with passed models ', function (done) {
    ...
    it('should fail to make reference between namespaces, without passed models ', function (done) {
        var modelId1 = H.uniqueId('model');
        var modelId2 = H.uniqueId('model');
        var ottomanA = H.setupOttoman('A');
        var Model1 = ottomanA.model(modelId1, {
     ...
     */
    it('should be able use a base ottoman more then once', function (done) {
        var modelId1 = H.uniqueId('model');
        var modelId2 = H.uniqueId('model');
        var ottomanA = H.setupOttoman('A');
        var Model1 = ottomanA.model(modelId1, {
    ...
    it('should n1ql query only in namespace', function (done) {
        ...
        ottomanA.ensureIndices(function (err) {
            ...
            ottomanB.ensureIndices(function (err) {
                ...
                setTimeout(function () {
                    H.saveAll([uxA, uyA, px1A, px2A, py1A, uxB, uyB, px1B, px2B, py1B], function (err) {
                        assert.isNull(err);
