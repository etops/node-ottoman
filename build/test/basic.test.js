...
describe('Models', function () {
    ...
    describe('Json format', function () {
        ...
        it('should serialize references as mongoose references with namespace', function () {
        ...
        it('should serialize mixed references correctly with namespace', function () {
            ottoman.namespace = 'TESTNAMESPACE';
            var Container = ottoman.model(H.uniqueId('model'), {
                myRef: { ref: 'Mixed' }
            });
