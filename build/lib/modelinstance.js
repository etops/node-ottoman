...
var isModelDataType = function (variableToCheck) {
    return variableToCheck instanceof ModelData;
};
function ModelData() {
    this.key = null;
    this.data = null;
...
var isModelRefData = function (variableToCheck) {
    return variableToCheck instanceof ModelRefData;
};
function ModelRefData() {
    this.key = null;
}
var isModelInstanceType = function (variableToCheck) {
    return variableToCheck instanceof ModelInstance;
};
/**
